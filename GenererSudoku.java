 ...
 * @author Isabelle
 */
public class GenererSudoku extends PremAlgo {
    ...
    */
    ...
    public void sudokualeatoire(int m){
        ...
        Random rand = new Random();
        while (n > m){	
        	// On sélectionne au hasard une case non vide
        	do {
            		i = rand.nextInt(9);
            		j = rand.nextInt(9);
            		k = this.grille[i][j];
               ...
               this.solution = this.PremResolverTest(affichageIteration,uneSeuleSolution,affichageSolutionUn,affichageSolutions,testPourGenerer);
